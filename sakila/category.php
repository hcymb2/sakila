...
if(isset($_POST["insert"]))
{
	...
	$insertResult = mysqli_query($conn, "INSERT INTO category (name, last_update) VALUES('$name', '$last_update');");
...
if(isset($_GET["update"]))
{
	...
	$category_id = $_GET["update"];
		...
		$selResult = mysqli_query($conn, "SELECT * FROM category WHERE category_id = $category_id;");
...
if(isset($_POST["update"]))
{
	...
	$updateResult = mysqli_query($conn, "UPDATE category SET name='$name', last_update='$last_update' WHERE category_id= $category_id;") or die($conn->error);
...
<html>
<head>
	<title>Sakila Database - Category Table</title>
...
<body>
		...
		<?php
			...
			?>
				...
				<div class="inputGrp">
					...
					<input type="number" name="category_id" value="<?php echo $category_id?>" readonly> <br/> 
				</div>
				<div class="inputGrp">	
					<label>name</label>
			...
			<?php else: ?>
				...
				<div class="inputGrp">
					<label>category_id</label>
					<input type="number" name="category_id" value="category_id" > <br/> 
				</div>
				<div class="inputGrp">
					<label>name</label>
	...
	<?php
		...
		$selectResult = mysqli_query($conn, "SELECT * FROM category;"); 
					...
					<table>
						<tr>
							...
							<?php 	if (!empty($_POST['selectField'])&&in_array("category_id",$_POST['selectField'])){ ?>
									...
									<td><button type="submit" class="update_btn" name="update"><a href="category.php?update=<?php echo $row['category_id']; ?>">Update</a></button> </td>
									<td><button type="submit"  class="delete_btn" name="delete"><a href="category.php?delete=<?php echo $row['category_id']; ?>" onclick="return confirm('You are about to delete this record.');">Delete</a></button> </td>
