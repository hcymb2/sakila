...
if(isset($_POST["insert"]))
{
    ...
    $insertResult = mysqli_query($conn, "INSERT INTO film_actor (film_id, last_update) VALUES('$film_id', '$last_update');");
...
if(isset($_GET["update"]))
{
	...
	$actor_id = $_GET["update"];
		...
		$selResult = mysqli_query($conn, "SELECT * FROM film_actor WHERE actor_id = $actor_id;");
...
if(isset($_POST["update"]))
{
	...
	$updateResult = mysqli_query($conn, "UPDATE film_actor SET film_id='$film_id', last_update='$last_update' WHERE actor_id=$actor_id;") or die($conn->error);
...
<html>
<head>
	<title>Sakila Database - Film_Actor Table</title>
...
<ul>
	...
	<li><a href="film_actor.php">FILMACTOR TABLE</a></li>
    ...
    <?php
		...
		$selectResult = mysqli_query($conn, "SELECT * FROM film_actor;"); 
					...
					<table>
						<tr>
							...
							<?php 	if (!empty($_POST['selectField'])&&in_array("actor_id",$_POST['selectField'])){ ?>
									...
									<td><button type="submit" class="update_btn" name="update"><a href="film_actor.php?update=<?php echo $row['actor_id']; ?>">Update</a></button> </td>
									<td><button type="submit"  class="delete_btn" name="delete"><a href="film_actor.php?delete=<?php echo $row['actor_id']; ?>" onclick="return confirm('You are about to delete this record.');">Delete</a></button> </td>
